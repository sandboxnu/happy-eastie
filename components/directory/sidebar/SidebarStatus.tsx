...
interface SidebarStatusProps {
  ...
  setMembers(n: number | undefined) : void;
  ...
  return (
    <Grid>
      ...
      <Checkbox.Group
        ...
        onChange={(e) => props.setLanguage(e as Language[])}
      ...
      <Input
        ...
        onChange={(e) => {
          if (!e.target.value) return props.setMembers(undefined);
          const num = parseInt(e.target.value);
          if (isNaN(num)) return;
          return props.setMembers(num);
        }}
      />
      <Spacer y={1} />
      ...
      <Checkbox.Group
        color="primary"
        className={styles.sidebarCheckboxGroup}
        onChange={(e) => props.setAccessibility(e as Accessibility[])}
